...
save_path = r'C:\Users\keyboard007\Desktop\CBRLR'  # Locally saves retrieved CB logs here
cb_path = r'C:\Windows\System32\winevt\Logs'  # Retrieves CB files from

max_file_size = 162500000 # Bytes: 62500000 bytes= 100Mb
extensions_to_grab = ['.evtx']
...
try:
    ...
    path = list(session.walk(cb_path, False))  # Walk everything. False performs a bottom->up walk, not top->down
    #print path
...
print("[INFO] IssduScanLOG Retrieve completed.")